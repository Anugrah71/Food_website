  ...
  return (
    <PasswordCard>
      <div className="text-center py-4">
        ...
        <h2 className="text-2xl font-black text-[#3d1a6e] mb-2">Password Updated!</h2>
        <p className="text-sm text-[#8e6db0] mb-8">Your password has been changed successfully. You're all set!</p>
        <button
          onClick={() => navigate("/")}
